...
# Still a model of the current token only, but now it knows its position and has a hidden layer
def linear(x, w):
...
# Repeat in sequence
num_steps = 200 # @param {"min": 1, "max": 5000, "log": true} number of training steps
